...
class MainMenuState extends MusicBeatState
{
	...
	public static var funkyPlayVersion:String = '1.0.0';
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, ClientPrefs.getResolution()[1] - 64, 0, "Funky Play v" + funkyPlayVersion, 12);
